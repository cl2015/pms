...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('date_of_bitrh')); ?>:</b>
	<?php echo CHtml::encode($data->date_of_bitrh); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('educational_background')); ?>:</b>
	<?php echo CHtml::encode($data->educational_background); ?>
	<br />
