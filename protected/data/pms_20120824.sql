...
-- ----------------------------
BEGIN;
INSERT INTO `honors` VALUES ('1', '奖励1', '级别1', '获奖人1', '2012-09-10', '北京', '1', '2012-08-24 17:43:57', '1', '2012-08-24 17:43:57');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `laboratories` VALUES ('1', '第一个实验室', '李贺', '普瑞明特', '62149482', '1', '2012-08-20 21:58:22', '1', '2012-08-20 21:58:22');
COMMIT;
...
-- ----------------------------
--  Table structure for `partents`
-- ----------------------------
DROP TABLE IF EXISTS `partents`;
CREATE TABLE `partents` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(512) DEFAULT NULL,
